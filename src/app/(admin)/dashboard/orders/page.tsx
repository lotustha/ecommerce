...
import { Package, Calendar, Eye, ArrowUpRight, Download } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a
          ...
          download
          className="btn btn-outline border-base-300 shadow-sm rounded-xl gap-2 hover:bg-base-200"
        >
