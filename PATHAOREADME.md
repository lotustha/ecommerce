...
dNZClZPIgkYzq79OGxkeujF6wnTnod9Kdn5CD3Bl
...
curl --location '{{base_url}}/aladdin/api/v1/stores' \
  ...
  --data '{
   ...
   "secondary_contact": "97XXXXXXXX",
   "otp_number": "98XXXXXXXX",
...
contact_number	string	Yes	Store contact person phone number. Contact number length should be 10 characters.
secondary_contact	string	No	Store contact person secondary phone number. Secondary contact number length should be 10 characters. This field is optional.
...
curl --location '{{base_url}}/aladdin/api/v1/orders' \
  ...
  --data '{
   ...
   "recipient_phone": "98XXXXXXXX",
   "recipient_address": "Thamel, Kathmandu, Nepal",
...
recipient_phone	string	Yes	Parcel receivers contact number. Recipient phone length should be 10 characters.
recipient_secondary_phone	string	No	Parcel receivers secondary contact number. Recipient secondary phone length should be 10 characters. This field is optional.
recipient_address	string	Yes	Parcel receivers full address. Address length should be between 3 to 220 characters.
recipient_city	integer	Yes	Parcel receiver’s city_id
recipient_zone	integer	Yes	Parcel receiver’s zone_id
recipient_area	integer	No	Parcel receiver’s area_id
delivery_type	integer	Yes	48 for Normal Delivery, 24 for On Express Delivery
  ...
  --data '{
    "orders": [
     ...
     },
     {
      ...
      "recipient_phone": "97XXXXXXXX",
      "recipient_address": "Lalitpur, Patan, Nepal",
      "recipient_city": {{city_id}},
      "recipient_zone": {{zone_id}},
      "delivery_type": 48,
      "item_type": 2,
...
recipient_name	string	Yes	Parcel receivers name. Name length should be between 3 to 100 characters.
recipient_phone	string	Yes	Parcel receivers contact number. Recipient phone length should be 10 characters.
recipient_secondary_phone	string	No	Parcel receivers secondary contact number. Recipient secondary phone length should be 10characters. This field is optional.
recipient_address	string	Yes	Parcel receivers full address. Address length should be between 3 to 220 characters.
recipient_city	integer	Yes	Parcel receiver’s city_id
recipient_zone	integer	Yes	Parcel receiver’s zone_id
recipient_area	integer	No	Parcel receiver’s area_id
...
Success Response: Status Code 200
{
   ...
   data: {
      data: [
         {
            city_id: 138,
            city_name: "Aadarshnagar (Birgunj)"
         },
         {
            city_id: 353,
            city_name: "Aanbukhaireni"
         },
         {
            city_id: 181,
            city_name: "Adarshanagar (Chitwan)"
         }
      ]
   }
}
      ...
      data: [
         {
            ...
            store_address: "Thamel, Kathmandu, Nepal",
            is_active: 1,
            city_id: "{{city_id}}",
            zone_id: "{{zone_id}}",
            hub_id: "{{hub_id}}",
