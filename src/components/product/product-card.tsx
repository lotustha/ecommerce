  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-3/4 w-full overflow-hidden rounded-2xl bg-base-200">
        ...
        <div className="absolute right-3 top-3 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <WishlistButton
            productId={product.id}
            className="rounded-full bg-white/80 p-2 text-gray-900 backdrop-blur-sm shadow-sm hover:bg-white"
          />
        </div>
