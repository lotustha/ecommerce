...
export default async function Navbar() {
  ...
  // Fetch settings and top categories
  const [settings, topCategories] = await Promise.all([
    getPublicSettings(),
  ...
  return (
    <div className="navbar bg-base-100/80 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-base-200 transition-all duration-300">
      ...
      <div className="navbar-start">
        ...
        <Link
          href="/"
          className="btn btn-ghost hover:bg-transparent flex items-center gap-2"
        >
          {storeLogo ? (
      ...
      <div className="navbar-end gap-1">
        ...
        <Link
          href="/wishlist"
          className="btn btn-ghost btn-circle btn-sm group tooltip tooltip-bottom"
          data-tip="Wishlist"
        >
