...
export const SettingsFormSchema = z.object({
  ...
  feature1Title: z.string().optional().nullable(),
  feature1Sub: z.string().optional().nullable(),
  feature2Title: z.string().optional().nullable(),
  feature2Sub: z.string().optional().nullable(),
  feature3Title: z.string().optional().nullable(),
  feature3Sub: z.string().optional().nullable(),
