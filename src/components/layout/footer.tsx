...
export default function Footer() {
  return (
    <footer className="bg-base-300 text-base-content mt-auto">
      {/* Main Footer Content */}
      {/* Added 'grid-cols-1 md:grid-cols-2 lg:grid-cols-4' to force layout */}
      <div className="footer p-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <aside>
          <div className="font-bold text-2xl mb-2 flex items-center gap-2">
            <span className="text-primary">Nepal</span> E-com
          </div>
          <p className="max-w-xs text-sm opacity-80">
            Your trusted destination for quality products from local vendors and
            global brands.
            <br />
            Delivering happiness across Nepal since 2024.
          </p>
        ...
        <nav className="flex flex-col gap-2">
          ...
          <span className="flex items-center gap-2 text-sm">
            <span>📍</span> New Road, Kathmandu
          </span>
          <span className="flex items-center gap-2 text-sm">
            <span>📞</span> +977-9800000000
          </span>
          <span className="flex items-center gap-2 text-sm">
            <span>📧</span> support@nepalecom.com
          </span>
