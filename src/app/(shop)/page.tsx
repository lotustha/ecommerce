    ...
    <div className="flex flex-col pb-24 space-y-16 md:space-y-24">
      ...
      <section className="relative min-h-[75vh] flex items-center justify-center overflow-hidden bg-base-300 rounded-b-[3rem] sm:rounded-b-[4rem] mx-2 sm:mx-4 mt-2">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-10">
          <div className="badge badge-primary badge-lg py-4 mb-6 font-bold uppercase tracking-widest shadow-xl shadow-primary/30 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <section className="relative z-20 -mt-38 px-4 md:px-8">
